...
gen tier_govt_ar = office_preload
replace tier_govt_ar = "Secretariat" if  m1s0q2_name_incorrect ==1
replace tier_govt_ar = "District" if  m1s0q2_name_incorrect ==2
...
gen office_clean = "Secretariat (or equivalent)" if  m1s0q2_name ==1
replace office_clean = "District office (or equivalent)" if  m1s0q2_name == 2

replace office_clean = "Directorate office (or equivalent)" if  tier_govt_ar == "Federal Directorate of Education" 
